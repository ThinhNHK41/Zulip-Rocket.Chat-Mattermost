...
\- Thiết lập trình điều khiển CSDL Database tại file
/opt/mattermost/config/config.json

vi /opt/mattermost/config/config.json

\- Thay các dòng sau bằng thông tin của mình. Và file cấu hình cài đặt
cơ sở dữ liệu PostgreSQL trong phần \"SqlSettings\".
...
\"DataSource\":
\"postgres://mmuser:mat-khau-db\@localhost:5432/mattermost?sslmode=disable&connect_timeout=10\",
